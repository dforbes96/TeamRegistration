...
<!-- Project Made using Visual Studio 2017; all work by David Forbes -->
...
<body>
    ...
    <form id="form1" runat="server">
        <div id="formTeam">
            ...
            <p>Email: &ensp; <asp:TextBox ID="Email1" runat="server"></asp:TextBox></p>
        ...
        <div id="joinTeam">
            ...
            <p>Email: &ensp; <asp:TextBox ID="Email2" runat="server"></asp:TextBox></p>
